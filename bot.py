...
def start(client, message):
    mention = f"Hello [{message.from_user.first_name}](tg://user?id={message.from_user.id})  my name is Song Assistant © \n\ni can download any video songs from youtube.  But now i only works for my owner's group.\n\n👉🏻 tap /help to know how to use me ❣️\n\nif you wanna add me to your group plz contact my owner 👇🏻"
    bot.send_message(chat_id=message.chat.id, text=mention, reply_to_message_id=message.id,     reply_markup=InlineKeyboardMarkup(
        [
